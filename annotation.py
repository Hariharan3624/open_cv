...
height_label_postion = (arrow_start[0] - 150, (arrow_start[1] + arrow_end[1]) // 2)
cv2.putText(image_rgb, f'Height: {height}px', height_label_postion, font, 0.8, (255, 255, 0), 2, cv2.LINE_AA)
